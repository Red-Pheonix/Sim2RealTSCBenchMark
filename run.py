...
parser.add_argument('--sumo_add', type=str, default=None, help="SUMO additional-files override for tsc runs")
...
parser.add_argument('-n', '--network', type=str, default="hz1x1", help="network name")

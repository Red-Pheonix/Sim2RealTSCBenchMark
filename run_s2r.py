...
parser.add_argument('--real_setting', type=str, default="default", help="SUMO additional-files override for the real sim2real environment")
...
parser.add_argument('-gt', '--gat_model', type=str, help='type of GAT used in training process to improve sim-to-real transfer')
